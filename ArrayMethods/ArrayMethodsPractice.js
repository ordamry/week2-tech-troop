...
//exercise 2:
console.log (users.filter(u => u.address.zipcode.startsWith("5")));

//exercise 3:
console.log (users.filter(u => u.address.zipcode.startsWith("5")).map(u => u.id));

//exercise 4:
console.log (users.filter(u => u.name.startsWith("C")).map(u => u.name));

//exercise 5:
console.log(users.every (u => u.address.city === "South Christy"));

//exercise 6:
console.log(users.filter(u => u.address.suite === "Apt. 950").map(u => u.company.name));
...
console.log(inventory.reduce((sum, i) => sum + i.price * i.quantity, 0))
